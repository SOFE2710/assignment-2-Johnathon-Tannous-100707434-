...
// register students
        ...
        jane.registerFor(sofe2710);
        jane.registerFor(mece3000);
        jane.registerFor(mece3000);
        jane.registerFor(mece3000);
...
// now check to see if it works
        ...
        String.valueOf(joseph.isRegisteredInCourse(sofe2710));
        System.out.println("Is Joseph registered in sofe2800: ");
        String.valueOf(joseph.isRegisteredInCourse(sofe2800));
        System.out.println("Is max registered in mece3000: ");
        String.valueOf(max.isRegisteredInCourse(mece3000));
        System.out.println("Is joseph registered in mece3000: ");
        String.valueOf(joseph.isRegisteredInCourse(mece3000));
        System.out.println("Joseph is registered in ECSE: ");
        String.valueOf(ecse.isStudentRegistered((Student)joseph));

        System.out.println("Chad is registered in ECSE:  ");
        String.valueOf(ecse.isStudentRegistered((Student)chad));
